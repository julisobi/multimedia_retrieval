...
def save_output(excel_file):
    ...
    new_df = pd.DataFrame({'path': df['path'].to_numpy(),
                           ...
                           'd1-1': get_single_hist_column(df, "d1", 0, 7000),
                           'd1-2': get_single_hist_column(df, "d1", 1, 7000),
                           'd1-3': get_single_hist_column(df, "d1", 2, 7000),
                           'd1-4': get_single_hist_column(df, "d1", 3, 7000),
                           'd1-5': get_single_hist_column(df, "d1", 4, 7000),
                           'd1-6': get_single_hist_column(df, "d1", 5, 7000),
                           'd1-7': get_single_hist_column(df, "d1", 6, 7000),
                           'd1-8': get_single_hist_column(df, "d1", 7, 7000),
                           'd1-9': get_single_hist_column(df, "d1", 8, 7000),
                           'd1-10': get_single_hist_column(df, "d1", 9, 7000),
