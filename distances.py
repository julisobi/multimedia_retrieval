...
def combine_distance(vector1, vector2):
    ...
    hista3_vector1 = [val * 0.04 for val in vector1[5:15]]
    hista3_vector2 = [val * 0.04 for val in vector2[5:15]]
    dist2 = earth_movers_distance(hista3_vector1, hista3_vector2)
    histd1_vector1 = [val * 0.04 for val in vector1[15:25]]
    histd1_vector2 = [val * 0.04 for val in vector1[15:25]]
    dist3 = earth_movers_distance(histd1_vector1, histd1_vector2)
    histd2_vector1 = [val * 0.04 for val in vector1[25:35]]
    histd2_vector2 = [val * 0.04 for val in vector1[25:35]]
    dist4 = earth_movers_distance(histd2_vector1, histd2_vector2)
    histd3_vector1 = [val * 0.04 for val in vector1[35:]]
    histd3_vector2 = [val * 0.04 for val in vector1[35:]]
